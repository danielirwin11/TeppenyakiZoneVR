...
/// </summary>
public class TeleportTargetHandlerCollider : TeleportTargetHandler
{
	public LayerMask HitCollisionLayerMask;
	...
	protected override bool ConsiderTeleport(Vector3 start, ref Vector3 end)
	{
		...
		if (LocomotionTeleport.AimCollisionTest(start, end, AimCollisionLayerMask, out AimData.TargetHitInfo))
		{
			...
			if (HitCollisionLayerMask == (HitCollisionLayerMask | (1 << AimData.TargetHitInfo.collider.gameObject.layer)))
				return true;
			else
            {
