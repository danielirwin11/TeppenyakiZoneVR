...
public class TeleportAimVisual : TeleportSupport
{
	...
	{
		_lineRenderer.sharedMaterial.color = obj.TargetValid ? validLocation : invalidLocation;

		//for (int i = 0; i < _lineRenderer.colorGradient.colorKeys.Length; i++)
		//	_lineRenderer.colorGradient.colorKeys[i].color = obj.TargetValid ? validLocation : invalidLocation; 
